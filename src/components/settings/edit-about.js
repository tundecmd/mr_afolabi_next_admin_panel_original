...
export const EditAbout = (props) => {
  ...
  EditAbout.getInitialProps = async (ctx) => {
    const res = await axios.get("http://localhost:2500/api/admin/about");
    return { res: res };
  };
  ...
  return (
    <form autoComplete="off" noValidate {...props}>
      <Card>
        <CardHeader subheader="" title="Edit About" sx={{ color: "primary.main" }} />
        <Divider />
        <CardContent>
